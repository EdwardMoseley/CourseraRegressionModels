...
We will plot all variables against all others to look for any obvious relationships.
...
In this analysis, we generated two models to explain differences in mileage per gallon using the mtcars data set. Our first linear model included only the transmission to predict mileage per gallon. Our second linear fit included weight in addition to the transmission type.
